...
(function(window, document, exportName) {
  ...
  var Tablist = function( selector ){
    ...
    function handlePanel( e ){
      ...
      if ( tabPanel.tablist.currentTabIndex === undefined ) {
        handlePanelFocus( e );
      }
    ...
    function handleTab( e ){
      ...
      if ( tab.tablist.currentTabIndex === undefined ) {
        handleFocus( e );
      }
    ...
    function setTablist( tablist ){
      ...
      tablist.multiselectable = tablist.hasAttribute( 'aria-multiselectable' );
      ...
      Array.prototype.forEach.call( tablist.querySelectorAll( '[role=tab]' ), function( tab ){
        ...
        if( tab.getAttribute( 'aria-expanded' ) === 'true' ){
          ...
          if( !tablist.multiselectable && !tablist.openedTab.length ){
        ...
        tab.addEventListener( 'click', handleDisplay );
        tab.addEventListener( 'focus', handleFocus );
        tab.addEventListener( 'keydown', handleTab );
        tab.tabPanel.addEventListener( 'focus', handlePanelFocus );
        tab.tabPanel.addEventListener( 'keydown', handlePanel );
      });
